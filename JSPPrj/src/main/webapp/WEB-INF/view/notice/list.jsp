	...
	<nav class="menu">
		...
		<main class="main">
				...
				<form class="table-form">
					<fieldset>
						...
						<select name="f">
							...
							<option ${(param.f=="writer_id")?"selected":""} value="writerId">작성자</option>
						</select> 
			...
			<%-- 	<%
					...
					<tr>
						<td>${n.id } </td>
						<td class="title indent text-align-left"><a href="detail?id=${n.id}">${n.title}</a><span></span>[${n.cmtCount }]</td>
						<td>${n.writerId}</td>
